...
<body>
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                ...
                <li>
                    <label>客户端IP</label><span>{{ $_SERVER['REMOTE_ADDR'] }}</span>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                <li>
                    <label>官方交流网站：</label><span><a href="#">http://dasheng.com</a></span>
                </li>
                <li>
                    <label>官方交流QQ群：</label><span><a href="#"><img border="0" src="">大圣</a></span>
                </li>
            </ul>
        </div>
    </div>
